...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        ...
        <div class="table-wrapper-scroll-y">
            ...
            <table class="table table-hover">
                ...
                foreach($akku_data as $key=>$value) {
                    echo "<tr class='anklickbar' onclick='myfunction($value->akku_id );'>";
                    echo "<td>".$value->akku_id."</td>";
        ...
        <a class="btn btn-default" href="<?php echo site_url("akku/add_akku") ?>" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Akku hinzufügen</a>
        </div>
    </div>
</div>
