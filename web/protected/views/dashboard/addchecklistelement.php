            ...
            <div class="">
                <div class="page-title">
                    <div class="title_left">
                        <h3>Checklisten Element hinzufügen</h3>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" data-parsley-validate action="<?php echo site_url("checklistelement/add_element") ?>" method="post" class="form-horizontal form-label-left">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <ul class="to_do">
                                            ...
                                            foreach($checklist_data as $checklist_key=>$checklist_value) {
                                                ...
                                                <li>
                                                    <p>
                                                        <input type="checkbox" value="<?php echo $checklist_value->checkliste_name_id; ?>" id="checklist" name="checklists[]" class="form-control flat col-md-7 col-xs-12"> <?php echo $checklist_value->bezeichnung; ?>
                                                    </p>
                                                </li>
