...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo base_url('/old_assests/css/bootstrap.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('/old_assests/css/dashboard.css')?>" rel="stylesheet">
...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        <div class="main">
            <h1 class="page-header">Checklisten Elemente</h1>
            ...
            <div class="table-wrapper-scroll-y">
                ...
                <table class="table table-hover">
                    ...
                    foreach($element_data as $key=>$value) {
                        echo "<tr class='anklickbar' onclick='myfunction($value->element_id );'>";
                        echo "<td>".$value->element_id."</td>";
